<%@ Page Title="" Language="C#" MasterPageFile="~/ClientUi/Admin.Master" AutoEventWireup="true" CodeBehind="AdministratorManagement.aspx.cs" Inherits="stadium_management.ClientUi.Pages.AdministratorManagement" %>
                            ...
                            <asp:GridView ID="grdAdministrators" CssClass="table table-bordered" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Editar">
                                        <ItemTemplate>
                                            <asp:ImageButton CssClass="iconAdmManage" ID="btnGetAdministrator" ImageUrl="~/ClientUi/Images/EditIcon.png"
                                    ...
                                    <asp:TemplateField HeaderText="Eliminar">
                                        <ItemTemplate>
                                            <asp:ImageButton CssClass="iconAdmManage" ID="btnDelete" ImageUrl="~/ClientUi/Images/DeleteIcon.png" OnClientClick="javascript:return confirm('Esta seguro que desea eliminarlo?');"
